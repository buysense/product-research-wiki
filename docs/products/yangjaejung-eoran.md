...
<div style="background:#ffffff; border:1px solid #e5e7eb; border-radius:12px; padding:14px 14px 10px; margin:14px 0 20px;">
  <svg viewBox="0 0 640 210" style="display:block; width:100%; height:auto;" aria-label="최근 가격 추이">
    ...
    <circle cx="89" cy="178" r="4" fill="#fdba74"></circle>
    <circle cx="110" cy="178" r="4" fill="#fdba74"></circle>
    <circle cx="130" cy="178" r="4" fill="#fdba74"></circle>
    <circle cx="151" cy="178" r="4" fill="#fdba74"></circle>
    <circle cx="172" cy="178" r="4" fill="#fdba74"></circle>
    <circle cx="193" cy="178" r="4" fill="#fdba74"></circle>
    <circle cx="214" cy="178" r="4" fill="#fdba74"></circle>
    <circle cx="234" cy="178" r="4" fill="#fdba74"></circle>
