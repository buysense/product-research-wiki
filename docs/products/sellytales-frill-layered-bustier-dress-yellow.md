...
<div style="background:#ffffff; border:1px solid #e5e7eb; border-radius:12px; padding:14px 14px 10px; margin:14px 0 20px;">
  ...
  <svg viewBox="0 0 640 210" style="display:block; width:100%; height:auto;" aria-label="최근 가격 추이">
    ...
    <path d="M 68 42 L 126 42 L 184 145 L 241 145 L 299 100 L 357 100 L 415 100 L 472 42 L 530 153 L 588 100 L 588 178 L 68 178 Z" fill="rgba(249,115,22,0.08)"></path>
    <path d="M 68 42 L 126 42 L 184 145 L 241 145 L 299 100 L 357 100 L 415 100 L 472 42 L 530 153 L 588 100" fill="none" stroke="#ea580c" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
    <circle cx="68" cy="42" r="4" fill="#fdba74"></circle>
    <circle cx="126" cy="42" r="4" fill="#fdba74"></circle>
    <circle cx="184" cy="145" r="4" fill="#fdba74"></circle>
